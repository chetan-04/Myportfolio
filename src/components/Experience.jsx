...
import { EXPERIENCES } from "../../constants"; // Ensure EXPERIENCES array is defined

const Experience = () => {
  const experienceRef = useRef(null); // Ref to the section
            ...
            >
              ...
              <div className="w-full md:w-3/4">
                <h3 className="mb-2 text-lg lg:text-2xl">
                  {exp.role} -{" "}
                  <span className="bg-gradient-to-t from-purple-400 to-pink-200 bg-clip-text text-transparent">
                    {exp.company}
                  </span>
                </h3>

                <p className="flex flex-wrap gap-2">{exp.description}</p>
